...
<!-- Template CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/style-starter.css">
...
<body>
	...
	<header id="site-header" class="fixed-top">
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-dark stroke">
				<h1>
					<a class="navbar-brand" href="<c:url value='/toIndex' />"> <span
          ...
          <a class="navbar-brand" href="#index.html">
              <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
				...
				<%-- 							href="<c:url value='/toIndex' />">Home <span class="sr-only">(current)</span></a> --%>
				<!-- 						</li> -->
				<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
					<ul class="navbar-nav mx-lg-auto">
						<li class="nav-item active"><a class="nav-link"
							href="<c:url value='/toIndex' />">Home <span class="sr-only">(current)</span>
						</a></li>
				...
				<div class="header-search">
					...
					<form action="<c:url value='/findByNameLike' />" method="GET"
						class='search-input'>
          ...
          <div class="mobile-position">
            <nav class="navigation">
              <div class="theme-switch-wrapper">
				...
				<%--                 <c:forEach var='mm' items='${cactusBean.courseBeans}'> --%>
				<%--                      </c:forEach> --%>
				<%--                      <c:forEach var='mm' items='${cactusBean.sessionBeans}'> --%>
				<%--                      </c:forEach> --%>
				<div class="dropdown">
						...
						<c:forEach var='mm' items='${cactus}'>
							<div class="cartlistbox111">
								...
								<div class="cartlistbox333">
									...
									<form action="<c:url value='/delete/${mm.getCartId()}' />"
				...
				<div class="dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
						...
						<a class="dropdown-item"
							href="<c:url value='/showYourProfile'  />"> <i
							class="far fa-address-card"></i> 個人資料
				...
				<!-- 下拉式登入<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
				...
				<!--  <div class="modal-body">
                        <form class="login">
                          ...
                          <a id="a2" href="signup.html">Sign up</a>
                          ...
                          <img class="img2" src="/assets/images/googleYAY.png" />
	...
	<div class="banner-wrap">
		<div class="banner-slider">
				...
				<div class="container">
					<div class="hero-content">
						<h1 data-animation="flipInX" data-delay="0.8s" data-color="#fff">
							我們提供優質的學習平台</h1>
						<p data-animation="fadeInDown" class="mt-4">Design BY :
							Chester.Hisao , Andy.Lee , Mousedown.Lee , Captain.Chou ,
							Long.Tsen , Ryan.Liao</p>
			...
			<div class="banner-slide bg4">
				<div class="container">
					<div class="hero-content">
						<h1 data-animation="flipInX" data-color="#fff" data-delay="0.8s">任何時間
							任何地點 隨心所欲</h1>
						<p data-animation="fadeInDown" class="mt-4">Design BY :
							Chester.Hisao , Andy.Lee , Mousedown.Lee , Captain.Chou ,
							Long.Tsen , Ryan.Liao</p>
						<div class="cta-btn" data-animation="fadeInUp" data-delay="1s">
							<a href="#url" class="btn btn-style btn-primary">聯絡我們</a>
						</div>
					</div>
				</div>
				<div class="hero-overlay"></div>
	...
	<div class="w3l-servicesblock2" id="services">
		<section id="grids5-block" class="py-5">
			<div class="container py-lg-5 py-md-4 py-2">
				<h3 class="title-big text-center">Cactus最受歡迎的課程種類</h3>
				<div class="flex-container">
					
						<div class="row mt-lg-5 mt-4 text-center flex-container">
						<c:forEach var='mm' items='${top3}'>
							<div class="col-lg-4 col-md-6">
								<div class="grids5-info">
									<a href="#service" class="d-block zoom"><img
										src="/cactus/images/${mm.getImage()}" alt=""
										class="img-fluid service-image" /></a>
									<div class="blog-info">
										<a href="#service" class="title">${mm.courseName}</a>
										<p class="text-para">${mm.coursedetail}</p>
									</div>
				...
				<!--                                     class="img-fluid service-image" /></a> -->
				<!--                             <div class="blog-info"> -->
				<!--                                 <a href="#service" class="title">加密貨幣投資</a> -->
				<!--                                 <p class="text-para">加密貨幣、區塊鏈、比特幣? 聽起來很難，但操作起來其實很簡單！帶你手把手進入加密貨幣市場這個瘋狂的世界吧！</p> -->
				<!--                             </div> -->
				<!--                             <a href="#learnmore" class="btn btn-style1 mt-3">Learn More</a> -->
				<!--                         </div> -->
				<!--                     </div> -->
	...
	<section class="w3l-gallery py-5" id="gallery">
		<div class="container py-lg-5 py-md-4 py-2">
			<div class="title-content text-center mb-5">
				<h3 class="title-small">課程種類</h3>
				<h3 class="title-big mx-lg-5">CACTUS 課程分類</h3>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-6 item">
					<a href="<c:url value='/typeofcoding'  />" class="zoom d-block">
						<img class="card-img-bottom d-block"
						src="${pageContext.request.contextPath}/images/software01.jpg"
						alt="Card image cap"> <span class="overlay__hover"></span> <span
						class="hover-content"> <span class="title">軟體編程</span> <span
							class="content">Quisque ut lectus, eros et, sed commodo
								risus.</span>
					</span>
					</a>
				</div>
				<div class="col-lg-4 col-md-6 item mt-md-0 mt-4">
					<a href="<c:url value='/typeofsport'  />" class="zoom d-block">
						<img class="card-img-bottom d-block"
						src="${pageContext.request.contextPath}/images/sport01old.jpg"
						alt="Card image cap"> <span class="overlay__hover"></span> <span
						class="hover-content"> <span class="title">運動</span> <span
							class="content">Quisque ut lectus, eros et, sed commodo
								risus.</span>
					</span>
					</a>
				...
				<div class="col-lg-4 col-md-6 item mt-lg-0 mt-4">
					<a href="<c:url value='/typeofmusic'  />" class="zoom d-block">
						<img class="card-img-bottom d-block"
						src="${pageContext.request.contextPath}/images/music01old.jpg"
						alt="Card image cap"> <span class="overlay__hover"></span> <span
						class="hover-content"> <span class="title">音樂</span> <span
							class="content">Quisque ut lectus, eros et, sed commodo
								risus.</span>
					</span>
					</a>
				...
				<div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
					<a href="<c:url value='/typeoflan'  />" class="zoom d-block"> <img
						class="card-img-bottom d-block"
						src="${pageContext.request.contextPath}/images/c4.jpg"
						alt="Card image cap"> <span class="overlay__hover"></span> <span
						class="hover-content"> <span class="title">語言</span> <span
							class="content">Quisque ut lectus, eros et, sed commodo
								risus.</span>
					</span>
					</a>
				...
				<div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
					<a href="<c:url value='/typeoffree'  />" class="zoom d-block">
						<img class="card-img-bottom d-block"
						src="${pageContext.request.contextPath}/images/c5.jpg"
						alt="Card image cap"> <span class="overlay__hover"></span> <span
						class="hover-content"> <span class="title">攝影</span> <span
							class="content">Quisque ut lectus, eros et, sed commodo
								risus.</span>
					</span>
					</a>
				...
				<div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
					<a href="<c:url value='/typeofeconomy'  />" class="zoom d-block">
						<img class="card-img-bottom d-block"
						src="${pageContext.request.contextPath}/images/c6.jpg"
						alt="Card image cap"> <span class="overlay__hover"></span> <span
						class="hover-content"> <span class="title">金融</span> <span
							class="content">Quisque ut lectus, eros et, sed commodo
								risus.</span>
					</span>
					</a>
