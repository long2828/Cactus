...
<a class="navbar-brand" href="<c:url value='/toIndex'  />" id="test3"> <span
	...
	<h2 style="margin-top: 3%; margin-left: 10%; font-size: 48px;">影片資訊修改</h2>

	<div style="margin-top: 3%; margin-left: 10%; width: 50%;">
		<form action="<c:url value='/reviseVideoBackToCoursesList/${courseId}' />" method="GET">
			<h4>Description:</h4>
			<input type='text' name='description' class='text' id='description'
				value='${mycourses.getCourseDescription()}'>
			<h4>Course Name:</h4>
			<input type='text' name='courseName' class='text' id='courseName'
				value='${mycourses.getCourseName()}'>
			
<!-- 			<input type='text' name='courseType' class='text' id='courseType' -->
<%-- 				value='${mycourses.getCourse_type()}'> --%>



			<h4>Price:</h4>
			<input type='text' name='price' class='text' id='price'
				value='${mycourses.getPrice()}'> 
			<p id="Longbutton" onclick="fFirst()" style="color:red;font-weight:bold">一鍵輸入</p>	
			<h4>Course Type:</h4>	
...
<%-- 				id='launched' value='${mycourses.getLaunched()}'> --%>
			<br>
			<br>
			...
			<button id='send' class="updatevideo"
				style="width: 35%; margin-top: 50px;">Update</button>
	...
	function fFirst(){
		...
		description.value="基礎Java 基礎觀念語法學習";
		courseName.value="Java 高級速成";
		price.value="1000"
	}
	</script>
