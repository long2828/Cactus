...
<body>
	<div id="mySidebar" class="sidebar" onmouseover="toggleSidebar()"
		...
		<a href="<c:url value='/uploadCourse'  />"><i
			class="material-icons">file_upload</i><span class="icon-text"></span>&nbsp;&nbsp;&nbsp;&nbsp;上傳課程<span></a><br>
	...
	<h2 style="margin-top: 3%; margin-left: 10%; font-size: 48px;">個人資料</h2>
	<p style="margin-left:53%; color:blue; font-weight:bold;">教師身分到期時間${profile.expirationDate } </p>
	<div class="flex-container">
		<div class="showprofile001 ">

			<div class="flex-container showprofile002">
				<h4>帳號:${profile.username}</h4>
			</div>
			...
			<div class="flex-container showprofile002">
				<h4>性別:${profile.gender}</h4>
			</div>

			<div class="flex-container showprofile002">
				<h4>生日:${profile.birth}</h4>
			</div>

			<div class="flex-container showprofile002">
				<h4>信箱:${profile.email}</h4>
			</div>

			<div class="flex-container showprofile002">
				<h4>電話:${profile.cellphone}</h4>
			</div>
...
<%--  --%>
		...
		<div class="showprofileintro">
			<div class="profileimg">
				<img src="<c:url value='/images/${profile.photopath}' />">
			</div>
			<br>
			<h4 style="margin-top: 8%;">教師自介</h4>
			<br>
			
			<p style="font-size:20px;colore:black; font-weight:bold;">${profile.intro}</p>
			
		</div>


	</div>
	<form action="<c:url value='/reviseYourProfile' />" method="get">
