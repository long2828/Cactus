...
<%--     <link rel='stylesheet' href='${pageContext.request.contextPath}/css/test' />  --%>
...
// 						alert("sad");
						...
						exhibitorright.innerHTML = abc(xhr.responseText);
						exhibitorright.innerHTML += "<h2 class='h22'><button id ='w'>想</button></h2>";
						...
						w.onclick = function() {
							  var xhr = new XMLHttpRequest();
								...
								xhr.send();	
								  xhr.onreadystatechange = function() {
										if (xhr.readyState == 4 && xhr.status == 200) {	
											exhibitorright.innerHTML = bcd(xhr.responseText);
		  ...
		  var xhr = new XMLHttpRequest();
			...
			xhr.send();	
			  xhr.onreadystatechange = function() {
					if (xhr.readyState == 4 && xhr.status == 200) {	
						exhibitorright.innerHTML = bcd(xhr.responseText);
// 						exhibitorright.innerHTML +="<h4>教師資格:否</h4>"
						
					}
	  }
	  }
	  
	  function abc(memberString){
		  var member = JSON.parse(memberString);
		  var segment = "<h3>"+member.username+"</h3>" + "<h3>想成為老師嗎?</h3><br>";
		  return segment;
	  }
	  
	  function bcd(memberString){
		  var member = JSON.parse(memberString);
		  ...
		  if(member.cellphone==null)
			  member.cellphone ="";
		  if(member.qualification_of_teacher=="F" ||member.qualification_of_teacher==null)
			  var valueQualification_of_teacher ="否";
		  else
			  valueQualification_of_teacher ="是";
		  var segment = "<h4>"+"帳號:"+member.username+"</h4><br>"+"<h4>"+"姓名:"+member.name+"</h4><br>"+
		  "<h4>"+"性別:"+member.gender+"</h4><br>"+"<h4>"+"生日:"+member.birth+"</h4><br>"+"<h4>"+"信箱:"+member.email+"</h4><br>"+"<h4>"+"手機:"+member.cellphone+"</h4><br>"
		  +"<h4>"+"教師資格:"+valueQualification_of_teacher+"</h4><br>";
          ...
          <div class="dli1">
            ...
            <li class="cl123">
              ...
              <h2 class="h22"><button id ='s'>評分紀錄</button></h2>        
                <h2 class="h22"><button id ='a'>修改個人資料</button></h2> 
                <h2 class="h22"><button id ='ms'>課程管理</button></h2>  
                <h2 class="h22"><button id ='us'>上傳課程</button></h2>
                 <h2 class="h22"><button id ='i'>收益</button></h2>           
