...
<body>
	...
	<h2 style="margin-top: 3%; margin-left: 10%; font-size: 48px;">上傳課程管理</h2>
	...
	<div class="mainkj3">
		...
		<c:forEach var='m' items='${course}'>
			<a href="<c:url value='/reviseCoursesList/${m.courseId}'  />" class="columnkj3 introdiv-2"><div>
			
				<div class="contentkj3">
				
					<img src="<c:url value='/images/${m.image}' />" style="width:100%"/>
					<h3>${m.courseName}</h3>
					<p>${m.courseDescription} </p>
