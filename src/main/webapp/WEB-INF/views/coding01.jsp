			...
			<nav class="navbar navbar-expand-lg navbar-dark stroke">
				<h1>
					<a class="navbar-brand"
						href="<c:url value='/toIndex'/>" id="test3">
...
<!-- 		購物車icon			 -->
					               <div class="dropdown"> 
				<i class="far fa-shopping-cart" data-toggle="modal" data-target="#exampleModalCenter" 
					style="font-size: 30px; color:#fff; padding:7px 0px 0px 13px ; " id="test2"></i>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">                  	                     
                     <div id="aabbabc" class="dropdown-item" ><i class="fas fa-shopping-cart" style="font-size: 29px;"></i> 我的購物清單</div>
                     <c:forEach var='mm' items='${cactus}'>
		<div class="cartlistbox111">

			<div class="cartlistbox222">
				<img class="cartlistimg11" src="<c:url value='/images/${mm.getCourseBean().getImage()}' />" />
			</div>
...
<%-- 					src="<c:url value='/images/lilstar.png' />" />(886)</span> --%>
				...
				<form action="<c:url value='/deletecoding/${mm.getCartId()}' />"
...
<!-- 						onclick="cartAlert();">加入購物車</button></span> -->
				<p class="price">NT$${mm.getCourseBean().getPrice()}</p>
                        ...
                        <a id="abbabbabbac" class="dropdown-item" href="<c:url value='/testbuy' />"><i class="fas fa-money-check-alt"></i> 結帳</a>
                      </div>
	 ...
	 <div class="dropdown"> 
                 <div class="cap10">
                   ...
                   <c:otherwise> 
                      ...
                      <a class="dropdown-item" href="<c:url value='/showYourProfile'  />"> <i class="far fa-address-card"></i> 個人資料</a>
		...
		<a class="active" href="<c:url value='/typeofcoding'  />">Coding</a> <a href="<c:url value='/typeofsport'  />">Sport</a>
		<a  href="<c:url value='/typeofmusic'  />">Music</a> <a href="<c:url value='/typeoflan'  />">Language</a> <a
			href="<c:url value='/typeofeconomy'  />">Economy</a> <a href="<c:url value='/typeoffree'  />">Photo</a>
	</div>

    <br>
	<br>
	<h2 style="margin-left:28%;">軟體 課程</h2>
	<br>
	<br>
...
<!--   </div> -->
  <c:forEach var='mm' items='${cactusCourse}'>
		<div class="box1">
			...
			<div class="box2">
			    <a  href="<c:url value='/course/${mm.courseId}'  />">
				<img class="img11" src="<c:url value='/images/${mm.image}'  />" />
				</a>
			</div>
			<div class="box3">
...
<!-- //讓課程版面上 如是老師本人看到 會show 我是上傳者 -->
				...
				<c:choose>
					...
					<c:when test="${ cactusBean.userId == mm.cactusBean.userId}">
						...
						<form action="<c:url value='/typeofcoding/${mm.courseId}' />"
							method="get" class="sp01">
							<div style="color: #FF0000">${e.msge}</div>
