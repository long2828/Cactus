...
<body>
    <div id="mySidebar" class="sidebar" onmouseover="toggleSidebar()" onmouseout="toggleSidebar()">
        ...
        <a href="<c:url value='/sessionRecords'  />"><i class="material-icons">pending_actions</i><span class="icon-text"></span>&nbsp;&nbsp;&nbsp;&nbsp;購買紀錄</a></span><br>
 
        <a href="#"><i class="material-icons">email</i><span class="icon-text"></span>&nbsp;&nbsp;&nbsp;&nbsp;課程管理<span></a><br> 
		<a href="<c:url value='/uploadCourse'  />"><i class="material-icons">email</i><span class="icon-text"></span>&nbsp;&nbsp;&nbsp;&nbsp;上傳課程<span></a><br> 
		<a href="#"><i class="material-icons">email</i><span class="icon-text"></span>&nbsp;&nbsp;&nbsp;&nbsp;收益<span></a><br> 
	...
	<div class="flex-container">
		...
		<a href="<c:url value='/RevisePhotoTeacher'  />" class="hkj1" style="margin-top: 3%; margin-left: 10%;"><h3>個人照片</h3></a>
	</div>
...
<!-- 			<form action="/action_page.php" style="width: 35%"> -->
			<label for="fname">ID</label> <input type="text" id="fname"	name="username" value="${reviseProfile.username}"> <label for="lname">姓氏</label> <input type="text" id="lname" name="name" value="${reviseProfile.name}"> 
			<label for="fname">電話</label> <input type="text" id="fname" name="cellphone" value="${reviseProfile.cellphone}">
