...
<body>
	<div id="mySidebar" class="sidebar" onmouseover="toggleSidebar()"
		...
		<a class="navbar-brand" href="index.html" id="test3"> <span
			class="fa fa-align-right" style="color: green;"></span> <span
			style="margin-left: 23px;">Cactus</span></a><br> <a href="#"><span><i
				class="material-icons">account_circle</i><span class="icon-text">&nbsp;&nbsp;&nbsp;&nbsp;個人資料</span></a><br>
		<a href="#"><i class="material-icons">pending_actions</i><span
			class="icon-text"></span>&nbsp;&nbsp;&nbsp;&nbsp;購買紀錄</a></span> </a><br> <a
			href="#"><i class="material-icons">school</i><span
			class="icon-text"></span>&nbsp;&nbsp;&nbsp;&nbsp;成為教師</span></a><br> <a
			href="#"><i class="material-icons">email</i><span
	...
	<div style="margin-top: 3%; margin-left: 10%; width: 50%;">
		<form action="<c:url value='/VideoTest' />" method="GET">
			...
			<input type='text' name='courseName' class='text' id='courseName'
				value='${video.courseName}'>
			<h4>courseType:</h4>
			<input type='text' name='courseType' class='text' id='courseType'
				value='${video.courseType}'>
			...
			<input type='datetime-local' name='launched' class='text'
				id='launched' value='${video.launched}'>
			<br>
			<br>
			<h4>video:</h4>
			<br>
			...
			<div style="margin-left: 10%;">
				<input type="file" name="video" id="video" value="${video.path }"
			...
			<div class="containerkj2" style="margin-left: 10%; margin-top: 50px;">
				...
				<div>
					<input id="default-btn" type="file" name="imgpath"
						class="inputfile" value="${video.image }"> <label
