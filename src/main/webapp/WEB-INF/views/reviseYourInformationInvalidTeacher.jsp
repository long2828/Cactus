...
<%-- 			<label for="fname">生日</label> <input type="text" id="fname" name="birth" value="${reviseProfile.birth}"> --%>
			...
			<input type='date' name='birth' class='text'
				id='fname' value='${reviseProfile.birth}'>
				<br>
			...
			<label for="fname">Password</label> <input type="password" id="fname" name="password" value="${reviseProfile.password}"> 
			<br>
...
<!-- 				<label for="fname">Password</label> <input type="text" id="fname" -->
<%-- 					name="password" value="${reviseProfile.password}"> <label for="fname">修改密碼</label><br> --%>
<!-- 					<label -->
<!-- 					for="subject">自介</label> -->
<!-- 				<textarea id="subject" name="intro" -->
<%-- 					placeholder="${reviseProfile.intro}" style="height: 200px"></textarea> --%>
<!-- </div> -->
<!-- </form> -->
			</form>
