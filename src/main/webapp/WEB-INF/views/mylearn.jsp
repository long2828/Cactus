...
<body>
	<div id="mySidebar" class="sidebar" onmouseover="toggleSidebar()"
		...
		<a class="navbar-brand" href="<c:url value='/toIndex'  />" id="test3"> <span
			...
			style="margin-left: 23px;">Cactus</span></a><br> <a href="<c:url value='/showYourProfile'  />"><span><i
				class="material-icons">account_circle</i><span class="icon-text">&nbsp;&nbsp;&nbsp;&nbsp;個人資料</span></a><br>
		<a href="<c:url value='/sessionRecord'  />"><i class="material-icons">pending_actions</i><span
			class="icon-text"></span>&nbsp;&nbsp;&nbsp;&nbsp;購買紀錄</a></span> </a><br> <a
			href="<c:url value='/teacherVerify'  />"><i class="material-icons">school</i><span
	...
	<div class="mainkj3">
		...
		<div class="rowkj3" style="margin-top:5%;">
			<c:forEach var='m' items='${membersession}'>
			<div class="columnkj3 introdiv-2">
				<div class="contentkj3">
					<a href="<c:url value='/musicvideopage/${m.getCourseBean().getCourseId()}' />">
					<img src="<c:url value='/images/${m.getCourseBean().getImage()}' />" style="width:100%"/>
					</a>
