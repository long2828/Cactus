...
<body>
	...
	<div align='center' id="ccc">
		...
		<table border='1'>
			...
			<c:forEach var='mm' items='${XX}'>
				<tr>	    
					<td>${mm.memberId}</td>
					<td>${mm.memberName}</td>
					<td>${mm.name}</td>
<!-- 					<td> -->
<%-- 						<form action="<c:url value='/Put_C_member/${mm.memberName}' />" --%>
<!-- 							method="post"> -->
<!-- 							<input type="hidden" name="_method" value="put" /> -->
<!-- 						</form> -->
<!-- 						<button id="put" -->
<%-- 							onclick="location.href='http://localhost:8080/cactus/Put_C_member/${mm.memberName}'"> --%>
<%-- 						<a href="<c:url value='/Put_C_member/${mm.memberName}' />">修改</a></button> --%>
						
						
<%-- 						<form action="<c:url value='/Delete_C_member/${mm.memberId}' />" --%>
<!-- 							method="post"> -->
<!-- 							<input type="hidden" name="_method" value="delete" /></form> -->
<!-- 							<button onclick="back()">刪除</button> -->
<%-- 							<input type="button" onclick="location.href='<c:url value='/C_members'  />'"> --%>
						
						
						
<%-- 						<form action="<c:url value='/blockademember/${mm.memberId}' />" --%>
<!-- 							method="get"> -->
<!-- 							<button onclick="block()">封鎖</button> -->
<!-- 						</form> -->

<%-- 						<form action="<c:url value='/unblockmember/${mm.memberId}' />" --%>
<!-- 							method="get"> -->
...
<!-- 						</form> -->
		...
		<a href="<c:url value='/'  />">回首頁</a> <a
			href="<c:url value='/back'  />">回後台首頁</a>
	</div>
