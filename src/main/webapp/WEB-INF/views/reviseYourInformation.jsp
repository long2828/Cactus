...
<body>
	...
	<div class="flex-container">
		<h3 style="margin-top: 3%; margin-left: 10%;border-bottom:7px solid black;">個人檔案</h3>
		<a href="<c:url value='/RevisePhoto'  />" class="hkj1" style="margin-top: 3%; margin-left: 10%;"><h3>個人照片</h3></a>
	</div>
...
<!-- 			<form action="/action_page.php" style="width: 35%"> -->
			<label for="fname">ID</label> <input type="text" id="fname"	name="username" value="${reviseProfile.username}"> <label for="lname">姓氏</label> <input type="text" id="lnamename" name="name" value="${reviseProfile.name}"> 
			<label for="fname">電話</label> <input type="text" id="fnametel" name="cellphone" value="${reviseProfile.cellphone}">
<%-- 			<label for="fname">生日</label> <input type="text" id="fname" name="birth" value="${reviseProfile.birth}"> --%>
			<label for="fname">生日</label>
			<br>
			<input type='date' name='birth' class='text' id='fname' value='${reviseProfile.birth}'>
			<br>
			<label for="lname">e-mail</label> <input type="text" id="lnameema"	name="email" value="${reviseProfile.email}">
			<label for="fname">性別</label><br><input type='radio' name='gender' value='男' id='gender' >
			<label for='sexMale'>男</label>
			<input type='radio' name='gender' value='女' id='gender'>
			<label for='sexFemale'>女</label><br>
			<label for="fname">Password</label> 
			<input type="password" id="fname" name="password" value="${reviseProfile.password}"><br>
<!-- 			<label for="subject">自介</label> -->
<!-- 			<textarea id="subject" name="intro" placeholder="請輸入自介內容" style="height: 200px"></textarea> -->
			<input type='hidden' name='intro' class='text'id='fname' value='請輸入自介內容'>
					<input type="submit" value="Submit" class="submitkj1">
								<h2 id="KJbutton" onclick="fFirst()">一鍵輸入</h2>
...
<!-- 					<label for="fname">再次輸入新密碼</label> <input type="text" id="fname" -->
<%-- 					name="password" value="${reviseProfile.password}"> --%>
<!-- 					<label -->
<!-- 					for="subject">自介</label> -->
