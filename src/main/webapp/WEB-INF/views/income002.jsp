...
window.onload=function(){
			 ...
			 function findeachincome(memberString){
				 var revenuemonthvalue = document.getElementById("revenuemonth").value;	
					...
					console.log((parseInt(revenuemonthvalue,10)+1));
					var segment =  "<span>"+(parseInt(revenuemonthvalue,10)+1)+"月:"+"</span>"+"$"+course[parseInt(revenuemonthvalue,10)];
					return segment;				              
				}
}
...
<body>
	...
	<div class="flex-container incomediv02"
		...
		<h2 style="font-size: 36px;">總收益: ${total} </h2>
		...
		<c:forEach var='a' items='${income}'>
			...
			<div class="incomediv flex-container incomeborder">
				...
				<div style="margin-left: 10%;">
					<h4>影片名稱: ${a.courseName}</h4>

					<h4 style="margin-top: 8px;">價格 ${a.price}</h4>

					<h4 style="margin-top: 8px;">購買人數:${a.total}</h4>
				</div>
