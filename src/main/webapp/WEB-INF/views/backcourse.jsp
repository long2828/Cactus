               ...
               <div class="dropdown"> 
                    ...
                    style="font-size: 28px; color:#fff; padding:7px 0px 0px 13px ; "  ></i></a>
                     ...
                     <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                      <h5><br>${sessionScope.cmemberBean.getName()}</h5>
                      <a class="dropdown-item" href="<c:url value='/C_users'  />"><i class="far fa-address-card"></i> 會員管理</a>
                       <a class="dropdown-item" href="<c:url value='/C_members'  />"><i class="far fa-address-card"></i> 員工管理</a>
                      <a class="dropdown-item" href="<c:url value='/getAllCourse'  />"><i class="fas fa-money-check-alt"></i> 課程管理</a>
                      <a class="dropdown-item" href="<c:url value='/getAllSession'  />"><i class="fas fa-book"></i> 購買紀錄管理</a>
                      <a class="dropdown-item" href="<c:url value='/getAllRevenue'  />"><i class="fas fa-book"></i> 收益管理</a>
                      <div class="out">
...
<hr>
<table border='1'>
<tr><th>影片編號</th><th>影片名稱</th><th>授課教師/上傳者</th><th>影片類型</th><th>影片價格</th><th>上傳日期</th><th>上傳課程</th><th>狀態</th><th>封鎖/解除封鎖</th></tr>
<c:forEach var='mm' items='${course}'>
  <tr> 	
     ...
     <td>${mm.price}元</td>
     <td>${mm.launched}</td>
     <td><a href="<c:url value='/musicvideopage/${mm.courseId}' />">
     <img src="<c:url value='/images/${mm.image}' />"></a></td>
      
     <td>
     <c:choose>
                   <c:when test="${mm.stateOfCourse == true}">
                         允許
                   </c:when>
                   <c:otherwise> 
                         封鎖
     ...
     <td>   	
     	...
     	<form action="<c:url value='/blockvideo/${mm.courseId}' />" method="get">

      		<button onclick="back()">封鎖</button>
     	</form>
     		
     	<form  action="<c:url value='/unblockvideo/${mm.courseId}' />" method="get">   		
       		<button id="unblock" onclick="block()">解除封鎖</button>
      	</form>
